...
public class Aplic {
    public static void main(String[] args) {
       ...
       for (i=0; i < 3; i++){
	    ...
	    System.out.println("\nMedida da altura: " + matRet[i].getAltura() + " " 
                                                      + matRet[i].getUnidadeMedida());
            System.out.println("Medida da base: " + matRet[i].getBase() + " " 
                                                  + matRet[i].getUnidadeMedida());	
            System.out.println("Área: "  + matRet[i].calcArea() + " " 
                                         + matRet[i].getUnidadeMedida() + "²");
            System.out.println("Perímetro: " + matRet[i].calcPerimetro() + " " 
                                             + matRet[i].getUnidadeMedida());
            System.out.println("Diagonal: "  + matRet[i].calcDiagonal() + " " 
                                               + matRet[i].getUnidadeMedida());
        }   		   
    }    
}
